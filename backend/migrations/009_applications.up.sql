CREATE TABLE IF NOT EXISTS applications (
    ...
    job_id UUID NOT NULL REFERENCES jobs(id) ON DELETE CASCADE, status STRING NOT NULL DEFAULT 'saved',
...
CREATE TABLE IF NOT EXISTS application_status_history (
    ...
    status STRING NOT NULL, changed_at TIMESTAMPTZ NOT NULL DEFAULT now(), CONSTRAINT application_status_history_primary PRIMARY KEY (id),
